...
class ControlPanel extends Component {
	...
	render() {
		const { classes, apiCacheInfo, limits, networkDetails } = this.props;
		return (
			<div className={classes.root}>
				...
				<Box className={classes.weigths}>
					...
					<WeightSlider index={0}
						...
						unitLimit="%" 
						minLimit={limits ? limits.inclusion_rate.min : 0}
						maxLimit={limits ? limits.inclusion_rate.max : 100} />
					<WeightSlider index={1}
						...
						unitLimit="%" 
						minLimit={limits ? limits.commission.min : 0}
						maxLimit={limits ? limits.commission.max : 100} />
					<WeightSlider index={2}
						...
						minLimit={limits ? limits.nominators.min : 0}
						maxLimit={limits ? limits.nominators.max : 1} />
					<WeightSlider index={3}
						...
						minLimit={limits ? limits.avg_reward_points.min : 0}
						maxLimit={limits ? limits.avg_reward_points.max : 1} />
					...
					<WeightSlider index={7}
						...
						unitLimit={networkDetails.token_symbol}
						minLimit={limits ? limits.total_stake.min : 0}
						maxLimit={limits ? limits.total_stake.max : 1} />
					<WeightSlider index={8}
						...
						minLimit={limits ? limits.judgements.min : 0}
						maxLimit={limits ? limits.judgements.max : 1} />
					<WeightSlider index={9}
						...
						minLimit={limits ? limits.sub_accounts.min : 0}
						maxLimit={limits ? limits.sub_accounts.max : 1} />
				</Box>
			</div>
		)
	}
