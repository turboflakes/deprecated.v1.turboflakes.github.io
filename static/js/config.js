...
var klaroConfig = {
  ...
  cookieName: "turboflakesNetworkCookie",
  ...
  // privacyPolicy: "https://turboflakes.com/privacy",
  ...
  services: [
    {
      ...
      cookies: [
        ...
        [/^_ga.*$/, "/", ".turboflakes.com"], //for the production version
        [/^_ga.*$/, "/", ".localhost"], //for the production version
        ["_gid", "/", ".turboflakes.com"], //for the production version
